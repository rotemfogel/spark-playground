...
object Schemas {
  ...
  val oldMoneSchema: StructType = StructType(
    Seq(
      StructField("mone_id", IntegerType),
      StructField("version", IntegerType),
      StructField("req_time", TimestampType),
      StructField("ts_date", DateType, nullable = false),
      StructField("user_timestamp", TimestampType),
      StructField("device_type ", StringType),
      StructField("app_version ", StringType),
      StructField("user_agent ", StringType),
      StructField("referrer ", StringType),
      StructField("traffic_referring_domain ", StringType),
      StructField("url ", StringType),
      StructField("url_first_level ", StringType),
      StructField("url_params ", StringType),
      StructField("machine_cookie ", StringType),
      StructField("machine_cookie_int", IntegerType),
      StructField("session_cookie ", StringType),
      StructField("session_cookie_key ", StringType),
      StructField("session_cookie_key_int", IntegerType),
      StructField("machine_ip ", StringType),
      StructField("machine_ip_int", IntegerType),
      StructField("page_type ", StringType),
      StructField("page_type_int", IntegerType),
      StructField("page_key ", StringType),
      StructField("page_key_machine_ip_int", IntegerType),
      StructField("referrer_key ", StringType),
      StructField("traffic_source_param ", StringType),
      StructField("traffic_source ", StringType),
      StructField("user_id", IntegerType),
      StructField("user_email ", StringType),
      StructField("user_newsletter_subscription_count", IntegerType),
      StructField("article_id", IntegerType),
      StructField("mc_id", IntegerType),
      StructField("pv_is_refreshed", IntegerType),
      StructField("other ", StringType),
      StructField("user_pro_status ", StringType),
      StructField("px_score", IntegerType),
      StructField("sa_geo", StringType))
  )
}
